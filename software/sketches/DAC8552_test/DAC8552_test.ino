...
void setup()
{
  ...
  //DIN = MOSI ==> pin 15 -> Digital 11
  //SCLK = SCK ==> pin 17 -> Digital 13
  //SYNC = SS ==> pin 14 -> Digital 10
...
{
  int v2 = map(v, 0, 255, 0, 64000);
  dac.setChipChanValue(1, 0, v2); // DAC8552 chip, channel B
  dac.setChipChanValue(1, 1, v2); // DAC8552 chip, channel B
